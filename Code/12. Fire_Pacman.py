...
bulletImagec21 = pygame.image.load('firecrashleft.png')
bulletStretchedImagec21 = pygame.transform.scale(bulletImagec21, (BULLETSIZE, BULLETSIZE))
bulletImagec22 = pygame.image.load('firecrashright.png')
bulletStretchedImagec22 = pygame.transform.scale(bulletImagec22, (BULLETSIZE, BULLETSIZE))
bulletImagec23 = pygame.image.load('firecrashdown.png')
bulletStretchedImagec23 = pygame.transform.scale(bulletImagec23, (BULLETSIZE, BULLETSIZE))
bulletImagec24 = pygame.image.load('firecrashup.png')
bulletStretchedImagec24 = pygame.transform.scale(bulletImagec24, (BULLETSIZE, BULLETSIZE))
...
while RESTART:
    ...
    while WINNER:
        ...
        for i in down2[:]:
            if player1.colliderect(i):
                windowSurface.blit(bulletImagec23, i)
                print(i)
                HP1 -= 10
                removedown2 = 1
                downcase2 = i
        if removedown2:
                down2.remove(downcase2)
                removedown2 = 0
                downcase2 = 0
        if HP1 < 0:
            HP1 += 10
