...
showitem = pygame.Rect(225, 225, 250, 250)
...
itemStretchedImage0p = pygame.transform.scale(itemImage0, (250, 250))
itemStretchedImage1p = pygame.transform.scale(itemImage1, (250, 250))
itemStretchedImage2p = pygame.transform.scale(itemImage2, (250, 250))
itemStretchedImage3p = pygame.transform.scale(itemImage3, (250, 250))
itemStretchedImage4p = pygame.transform.scale(itemImage4, (250, 250))
itemStretchedImage5p = pygame.transform.scale(itemImage5, (250, 250))
itemStretchedImage6p = pygame.transform.scale(itemImage6, (250, 250))
itemStretchedImage7p = pygame.transform.scale(itemImage7, (250, 250))
...
turnrightImage = pygame.image.load('turnright.png')
turnrightStretchedImage = pygame.transform.scale(turnrightImage, (50, 50))
turnleftImage = pygame.image.load('turnleft.png')
turnleftStretchedImage = pygame.transform.scale(turnleftImage, (50, 50))
itemselectImage = pygame.image.load('itemselect1.png')
itemselectStretchedImage = pygame.transform.scale(itemselectImage, (600, 700))
...
itemonbutton.centery = 500
onbutton = pygame.Rect(290, 480, 60, 40)
itemoff = basicFont3.render(' OFF ', True, WHITE)
itemoffbutton = itemoff.get_rect()
itemoffbutton.centerx = 375
itemoffbutton.centery = 500
offbutton = pygame.Rect(345, 480, 60, 40)
onoffcontrol = [pygame.Rect(285, 480, 60, 40), pygame.Rect(285, 480, 60, 40), pygame.Rect(285, 480, 60, 40), pygame.Rect(285, 480, 60, 40), pygame.Rect(285, 480, 60, 40), pygame.Rect(285, 480, 60, 40), pygame.Rect(285, 480, 60, 40), pygame.Rect(285, 480, 60, 40)]
text1 = basicFont3.render('Player1 WIN!', True, BLACK, WHITE)
text2 = basicFont3.render('Player2 WIN!', True, BLACK, WHITE)
...
while RESTART:
        ...
        if not MOVING:
            ...
            if turnrighttime >= 25 or turnlefttime >= 25:
                ...
                if ceta >= 2*math.pi - 0.1 and ceta <= 2*math.pi + 0.1:
                    ceta = 0
            pygame.draw.rect(windowSurface, WHITE, (340+300*math.cos(ceta),340+300*math.sin(ceta), 20, 20))
            pygame.draw.rect(windowSurface, WHITE, (340+300*math.cos(ceta+math.pi/4),340+300*math.sin(ceta+math.pi/4), 20, 20))
            pygame.draw.rect(windowSurface, WHITE, (340+300*math.cos(ceta+math.pi/2),340+300*math.sin(ceta+math.pi/2), 20, 20))
            pygame.draw.rect(windowSurface, WHITE, (340+300*math.cos(ceta+math.pi*3/4),340+300*math.sin(ceta+math.pi*3/4), 20, 20))
            pygame.draw.rect(windowSurface, WHITE, (340+300*math.cos(ceta+math.pi),340+300*math.sin(ceta+math.pi), 20, 20))
            pygame.draw.rect(windowSurface, WHITE, (340+300*math.cos(ceta+math.pi*5/4), 340+300*math.sin(ceta+math.pi*5/4), 20, 20))
            pygame.draw.rect(windowSurface, WHITE, (340+300*math.cos(ceta+math.pi*3/2), 340+300*math.sin(ceta+math.pi*3/2), 20, 20))
            pygame.draw.rect(windowSurface, WHITE, (340+300*math.cos(ceta+math.pi*7/4), 340+300*math.sin(ceta+math.pi*7/4), 20, 20))
    ...
    while WINNER:
        ...
        if ITEMCOUNTER >= ITEMTIME and ROBOT == 0:
            ...
            if randem == 4:
                while (not(randem1 >= pplayer1.left-ITEMSIZE-30 and randem1 <= pplayer1.right+30) and not(randem1 >= pplayer2.left-ITEMSIZE-30 and randem1 <= pplayer2.right+30) and not(randem2 >= pplayer1.top-ITEMSIZE-30 and randem2 <= pplayer1.bottom+30) and not(randem2 >= pplayer2.top-ITEMSIZE-30 and randem2 <= pplayer2.bottom+30)):
        ...
        if ROBOT:
            ...
            if moveUp2 and pplayer2.top > WINDOWHEIGHT/3*2 + BULLETSIZE/2 and pplayer2.bottom < WINDOWHEIGHT/3*2 + BULLETSIZE/2  and pplayer2.right > WINDOWWIDTH/3 and pplayer2.left < WINDOWWIDTH/3*2:
                pplayer2.right = WINDOWWIDTH/2 - SIZE2/2
                pplayer2.top = WINDOWHEIGHT/2 - SIZE2/2 + SIZE2/10
            if moveDown2 and pplayer2.bottom < WINDOWHEIGHT/3 + BULLETSIZE/2 and pplayer2.top > WINDOWHEIGHT/3 + BULLETSIZE/2 and pplayer2.right > WINDOWWIDTH/3 and pplayer2.left < WINDOWWIDTH/3*2:
                pplayer2 = pygame.Rect(WINDOWWIDTH/2 - SIZE2/2, WINDOWHEIGHT/2 - SIZE2/2 + SIZE2/10, SIZE2, SIZE2)
            if moveRight2 and pplayer2.right < WINDOWWIDTH/3 and pplayer2.left > WINDOWWIDTH/3 and pplayer1.bottom > WINDOWHEIGHT/3 and pplayer2.top < WINDOWHEIGHT/3*2:
                pplayer2 = pygame.Rect(WINDOWWIDTH/2 - SIZE2/2, WINDOWHEIGHT/2 - SIZE2/2 + SIZE2/10, SIZE2, SIZE2)
            if moveLeft2 and pplayer2.left > WINDOWWIDTH/3*2 and pplayer2.right < WINDOWWIDTH/3*2 and pplayer1.bottom > WINDOWHEIGHT/3 and pplayer2.top < WINDOWHEIGHT/3*2:
                pplayer2 = pygame.Rect(WINDOWWIDTH/2 - SIZE2/2, WINDOWHEIGHT/2 - SIZE2/2 + SIZE2/10, SIZE2, SIZE2)
    ...
    while GAMEEND:
        ...
        mousex = 0
        text = basicFont2.render('press to play again', True, BLACK, WHITE)
